...
function aboo_register_post_types()
{
    $labels = array(
        'name'                  => _x('Institutions', 'Post Type General Name', 'text_domain'),
        'singular_name'         => _x('Institution', 'Post Type Singular Name', 'text_domain'),
        'menu_name'             => __('Institutions', 'text_domain'),
        'name_admin_bar'        => __('Institution', 'text_domain'),
    ...
    $args = array(
        'label'                 => __('Institution', 'text_domain'),
        'description'           => __('Institutions', 'text_domain'),
        'labels'                => $labels,
...
add_action('init', 'aboo_register_post_types', 0);
